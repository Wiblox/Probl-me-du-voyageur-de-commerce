...
public class TSP extends DemoProject {
	...
	public TSP(Evaluation evaluation) throws InvalidProjectException {
		super(evaluation);
		this.addAuthor ("KV & BN");
		this.setMethodName ("Genetic is magic");	}
